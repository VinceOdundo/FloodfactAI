...
const VARIANT_CLASSES: Record<Variant, string> = {
  primary: "bg-brand-600 text-cream shadow-sm shadow-brand-900/20 hover:bg-brand-700 focus-visible:outline-brand-600",
...
export const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant = "primary", size = "md", ...props }, ref) => (
    <button
      ref={ref}
      className={cn(
        "inline-flex items-center justify-center gap-2 rounded-full font-medium tracking-wide transition-colors disabled:opacity-50 disabled:pointer-events-none focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2",
